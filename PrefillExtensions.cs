    ...
    public static void Prefill(this V1ServiceOwnerDialogsCommandsCreate_Dialog dialog, DialogPrefill prefillType)
    {
        switch (prefillType)
        {
            ...
            case DialogPrefill.Skattemeldig:
                ...
                //Title
                dialog.Content.Title = new V1CommonContent_ContentValue
                {
                ...
                //Summary
                dialog.Content.Summary = new V1CommonContent_ContentValue
                {
                    MediaType = "text/plain",
                    Value =
                    [
                ...
                //Sender Name
                dialog.Content.SenderName = new V1CommonContent_ContentValue
                {
                    MediaType = "text/plain",
                    Value =
                    [
                ...
                //Additional Info
                dialog.Content.AdditionalInfo = new V1CommonContent_ContentValue
                {
                    MediaType = "text/plain",
                    Value =
                    [
                ...
                dialog.Content.MainContentReference = new V1CommonContent_ContentValue
                {
